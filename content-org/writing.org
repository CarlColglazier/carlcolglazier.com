...
MIDI](/notes/acoustics/midi-instrument-control-supercollider/) is
...
[posts](/notes/acoustics/midi-instrument-control-supercollider/) have
worked through some building blocks for using SuperCollider as a
platform for creativity. As I wrote in [[/notes/acoustics/paradox-of-creativity/]["The Paradox of Creativity"]], I
...
** TODO Controlling Synths with MIDI in SuperCollider
...
** TODO Making Connections: MIDI in SuperCollider
The [[/notes/acoustics/starting-supercollider/][previous post]] demonstrated the process of setting up SuperCollider
...
[gscholar]:
https://scholar.google.com/citations?hl=en&user=18JgozoAAAAJ&view_op=list_works&sortby=pubdate
...
+ [*Intellectual
  Property*](https://www.youtube.com/watch?v=c_SvgFo71x0) (2012) [^ip]
+ [*The Great
