...
I study computer science and communication (media) at North Carolina State University in Raleigh,
where I am a [[https://caldwellfellows.ncsu.edu/][Caldwell Fellow]] and [[https://ids.chass.ncsu.edu/dual/franklin.php][Benjamin Franklin Scholar]].
I graduate December 2019. 

My research interests span the intersection of technology, media, and society.

** What I do

My art reveals the hidden history and technology behind everyday institutions.
You may also be interested in my catalogue of [[/code][code projects]] and [[/media][films]].
I also vlog regularly on [[https://youtube.com/carlcolglazier][YouTube]].
* Notes Section
:PROPERTIES:
...
+ [[https://cheesecake.live/][Cheesecake Live]] is an evidence-based scouting and statistics approach to
  the /FIRST/ Robotics Competition.
+ [[https://github.com/CarlColglazier/emojidentity][Emojidentity]] is an inquiry on the use of emoji as a messaging device
...
+ Kvizo was a practice and learning tool for adademic quiz bowl (2015-2017).
* Research
:PROPERTIES:
:EXPORT_HUGO_SECTION: /
