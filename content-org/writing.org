...
* TODO Speaking into the Void
  ...
  :END:
How do we measure...well, anything? In research design, /operationalization/ describes the process of turning the intangible into a measurable variable. The trick is to tally some other variable which closely correlates with the desired variable.

Of course, this measure isn't going to be perfect. If you sampled some weeks, you might conclude that I don't like coffee at all: bodies are fragile things and sometimes I must forgo my daily cup(s)-of-joe for my health.
