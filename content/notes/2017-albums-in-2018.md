...
{{< figure src="/images/all_music_distribution_hist.png" caption="Figure 1: **Number of songs streamed per month.** My 2018 streams broadly matched those from other years. Note: There were a couple of periods where scrobbling broke." >}}
...
I listen to a _lot_ of Charli XCX, so let's filter the results to
